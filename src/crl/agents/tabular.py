...
class DynaVAgent:
    ...
    def _greedy_action(self, s: State) -> Action:
        ...
        for a in self.actions:
            ...
            if G_worstcase > v_next:
                v_next = G_worstcase
                a_next = a
            elif G_worstcase == v_next:  # split ties randomly
    ...
    def observe(self, obs: Observation) -> None:
        ...
        if not self.use_predictor:  # don't learn if using CP
        ...
        # TODO: the predictor is collecting nonconfority scores generated by a still-learning world model,
